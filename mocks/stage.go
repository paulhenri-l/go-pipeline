...
// Source: github.com/paulhenri-l/go-pipeline/contracts (interfaces: Stage,MapStage,FilterStage,FlatMapStage,TumblingWindowStage)
...
import (
	...
	repo "github.com/paulhenri-l/go-pipeline/repo"
)
...
// MockTumblingWindowStage is a mock of TumblingWindowStage interface.
type MockTumblingWindowStage struct {
	ctrl     *gomock.Controller
	recorder *MockTumblingWindowStageMockRecorder
}

// MockTumblingWindowStageMockRecorder is the mock recorder for MockTumblingWindowStage.
type MockTumblingWindowStageMockRecorder struct {
	mock *MockTumblingWindowStage
}

// NewMockTumblingWindowStage creates a new mock instance.
func NewMockTumblingWindowStage(ctrl *gomock.Controller) *MockTumblingWindowStage {
	mock := &MockTumblingWindowStage{ctrl: ctrl}
	mock.recorder = &MockTumblingWindowStageMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockTumblingWindowStage) EXPECT() *MockTumblingWindowStageMockRecorder {
	return m.recorder
}
...
// Process indicates an expected call of Process.
func (mr *MockTumblingWindowStageMockRecorder) Process(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
